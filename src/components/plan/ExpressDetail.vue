    ...
    <div class="plan-detail__content">
      ...
      <div class="content-item line-item">
        ...
        <div class="content-item-detail">
          ...
          <div class="line-item__intro">
            <p>运输方式：{{TRANSPACKTYPES[data.transPackType]}}·直达</p>
          </div>
          <div class="line-item__intro">
            <p>全程耗时：4 天</p>
          </div>
      ...
      <div class="content-item fee-item">
        ...
        <div class="content-item-detail">
          <div class="fee-item__column">
            <p class="fee-item__header">出口费用<span class="tip">({{partDetail2.currency | uppercase}})</span></p>
            <el-tooltip 
              placement="right"
          ...
          <div class="fee-item__column">
            <p class="fee-item__header">运输费用<span class="tip">({{partDetail3.currency | uppercase}})</span></p>
          ...
          <div class="fee-item__separator"></div>
          <div class="fee-item__column">
            <p class="fee-item__header">进口费用<span class="tip">({{partDetail4.currency | uppercase}})</span></p>
            <el-tooltip 
              placement="right"
...
export default {
  ...
  computed: {
    ...
    ShowPart1Info () {
      const config = this.CHARGEDETAIL['EXPRESS']
