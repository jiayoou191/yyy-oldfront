    ...
    <div class="plan-detail__content">
      ...
      <div class="content-item line-item">
        ...
        <div class="content-item-detail">
          ...
          <div class="line-item__intro">
            <p>起飞日期：每{{info['etd'] | weekday}}发货，提前 2 天提货集装箱</p>
            <p>全程耗时：{{parseInt(info['transittime'] || 0) + 4}} 天</p>
          </div>
          <div class="line-item__intro">
            <p>运输方式：{{TRANSPACKTYPES[transportRoute.transPackType]}} - {{info['dir'] ? `中转站:${info['dir'].toUpperCase()}` : '直达'}}</p>
...
export default {
  ...
  computed: {
    ...
    ShowPart1Info () {
      const config = this.CHARGEDETAIL['AIR']
